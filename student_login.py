...
def login():
    ...
    Label(root2, text="").pack()
    Button(root2, text="User Login", bg="lightblue", fg='white', relief="groove", font=('arial', 12, 'bold'),command=login_verification).pack()
...
def logged():
    ...
    Button(logged_message, text="Login To quiz", bg="blue", fg='white', relief="groove", font=('arial', 12, 'bold')).pack()
...
def main_display():
    ...
    Button(root,text='StudentLog In', height="1",width="20", bd=8, font=('arial', 12, 'bold'), relief="groove", fg="white",
