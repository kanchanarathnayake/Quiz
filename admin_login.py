...
connectiondb = mysql.connector.connect(host="localhost",user="root",passwd="",database="quiz")
...
def login():
    ...
    Label(root2, text="").pack()
    Button(root2, text="Admin Login", bg="blue", fg='white', relief="groove", font=('arial', 12, 'bold'),command=login_verification).pack()
...
def logged():
    ...
    Button(root,text='Upload Quiz', height="1",width="20", bd=8, font=('arial', 12, 'bold'), relief="groove", fg="white",
                   bg="blue").pack()
    Button(logged_message, text="Upload Quiz", bg="blue", fg='white', relief="groove", font=('arial', 12, 'bold')).pack()
...
def login_verification():
    ...
    sql = "select * from Admin where User_Name = %s and Pass = %s" 
...
def main_display():
    ...
    root.title("Login System(MIT Kelaniya Mini Project)")
    root.geometry("500x500")
    Label(root,text='Welcome to Log In System',  bd=20, font=('arial', 20, 'bold'), relief="groove", fg="white",
                   bg="brown",width=300).pack()
    Label(root,text="").pack()
    
    Label(root,text="").pack()
    Button(root,text='Admin Log In', height="1",width="20", bd=8, font=('arial', 12, 'bold'), relief="groove", fg="white",
